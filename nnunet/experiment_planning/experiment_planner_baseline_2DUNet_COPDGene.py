...
class ExperimentPlanner2D_COPDGene(ExperimentPlanner2D):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner2D_COPDGene, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
